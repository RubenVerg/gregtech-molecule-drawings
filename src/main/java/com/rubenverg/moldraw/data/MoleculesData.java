...
public class MoleculesData {
    ...
    public static Map<ResourceLocation, Molecule> molecules() {
        ...
        molecules.put(GTCEu.id("cryptand"), new Molecule()
                ...
                .bond(16, 17)
                .bond(17, 0)
                .bond(6, 18, Bond.Type.OUTWARD)
                .bond(18, 19, Bond.Type.THICK)
                .bond(19, 20, Bond.Type.THICK)
                .bond(20, 21, Bond.Type.THICK)
                .bond(21, 22, Bond.Type.THICK)
                .bond(22, 23, Bond.Type.THICK)
                .bond(23, 24, Bond.Type.THICK)
                .bond(24, 25, Bond.Type.THICK)
                .bond(15, 25, Bond.Type.OUTWARD));
        molecules.put(GTCEu.id("cryptand_k"), new Molecule()
                ...
                .invAtom(1.195f, -3.446f)
                .invAtom(0.392f, -2.866f)
                .atom(Element.create("K⁺"), 3.360f, -1.447f)
                .bond(0, 1)
                .bond(1, 2)
                .bond(2, 3)
                .bond(3, 4)
        ...
        molecules.put(GTCEu.id("cryptand_na"), new Molecule()
                ...
                .invAtom(1.195f, -3.446f)
                .invAtom(0.392f, -2.866f)
                .atom(Element.create("Na⁺"), 3.360f, -1.447f)
                .bond(0, 1)
                .bond(1, 2)
                .bond(2, 3)
                .bond(3, 4)
        ...
        molecules.put(GTCEu.id("cryptand_li"), new Molecule()
                ...
                .invAtom(1.195f, -3.446f)
                .invAtom(0.392f, -2.866f)
                .atom(Element.create("Li⁺"), 3.360f, -1.447f)
                .bond(0, 1)
                .bond(1, 2)
                .bond(2, 3)
                .bond(3, 4)
        ...
        molecules.put(GTCEu.id("thiophene"), new Molecule()
                ...
                .bond(0, 1)
                .bond(2, 0, Bond.Type.DOUBLE)
                .bond(1, 3, Bond.Type.DOUBLE)
                .bond(2, 4)
                .bond(3, 4));
        ...
        molecules.put(GTCEu.id("benzoyl_peroxide"), new Molecule()
                ...
                .bond(14, 15)
                .bond(15, 16)
                .bond(16, 17, Bond.Type.DOUBLE_CENTERED)
                .bond(16, 7));
        {
        ...
        molecules.put(GTCEu.id("sorbitol"), new Molecule()
                .uv()
                .atom(Element.O.one(), null, null, null, Element.H.one(), 0, 0)
                .invAtom(1, 0)
                .invAtom(1, 1)
        ...
        molecules.put(GTCEu.id("poly_amic_acid"), new Molecule()
                ...
                .bond(4, 5, Bond.Type.DOUBLE)
                .bond(5, 12)
                .bond(12, 11, Bond.Type.DOUBLE)
                .bond(11, 10)
                .bond(10, 9, Bond.Type.DOUBLE)
                .bond(9, 4)
                .bond(10, 13)
                .bond(13, 14, Bond.Type.DOUBLE_CENTERED)
                .bond(13, 15)
                .bond(11, 16)
                .bond(16, 17, Bond.Type.DOUBLE_CENTERED)
                .bond(16, 18)
                .bond(15, 19)
                .bond(19, 24, Bond.Type.DOUBLE)
                .bond(24, 23)
                .bond(23, 22, Bond.Type.DOUBLE)
                .bond(22, 21)
                .bond(21, 20, Bond.Type.DOUBLE)
                .bond(20, 19)
                .bond(22, 25)
                .bond(25, 26)
                .bond(26, 27)
        ...
        molecules.put(GTCEu.id("oxydianiline"), new Molecule()
                ...
                .bond(15, 10, Bond.Type.DOUBLE)
                .bond(13, 16));
        molecules.put(GTCEu.id("aniline"), new Molecule()
                .uv()
                .invAtom(0, 0)
                .invAtom(-1, 1)
                .invAtom(-1, 2)
        ...
        molecules.put(GTCEu.id("diethylenetriamine_pentaacetonitrile"), new Molecule()
                ...
                .bond(9, 10)
                .bond(10, 11)
                .bond(11, 12, Bond.Type.TRIPLE)
                .bond(6, 13)
                .bond(13, 14)
                .bond(14, 15, Bond.Type.TRIPLE)
                .bond(3, 16)
                .bond(16, 17)
                .bond(17, 18, Bond.Type.TRIPLE)
                .bond(9, 19)
                .bond(19, 20)
                .bond(20, 21, Bond.Type.TRIPLE));
        molecules.put(GTCEu.id("diethylenetriaminepentaacetic_acid"), new Molecule()
                ...
                .bond(10, 11)
                .bond(11, 12)
                .bond(1, 13, Bond.Type.DOUBLE_CENTERED)
                .bond(11, 14, Bond.Type.DOUBLE_CENTERED)
                .bond(6, 15)
                .bond(15, 16)
                .bond(16, 17)
                .bond(16, 18, Bond.Type.DOUBLE_CENTERED)
                .bond(3, 19)
                .bond(19, 20)
                .bond(20, 21, Bond.Type.DOUBLE_CENTERED)
                .bond(20, 22)
                .bond(9, 23)
                .bond(23, 24)
                .bond(24, 25, Bond.Type.DOUBLE_CENTERED)
                .bond(24, 26));
        ...
        molecules.put(GTCEu.id("adipic_acid"), new Molecule()
                ...
                .bond(5, 6)
                .bond(6, 7)
                .bond(1, 8, Bond.Type.DOUBLE_CENTERED)
                .bond(6, 9, Bond.Type.DOUBLE_CENTERED));
