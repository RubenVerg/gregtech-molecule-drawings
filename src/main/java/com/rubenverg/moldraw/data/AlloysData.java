...
public class AlloysData {
    ...
    public static Map<ResourceLocation, Optional<List<Pair<ResourceLocation, Long>>>> alloys() {
        ...
        alloys.put(GTCEu.id("echolumium"), Optional.empty());
        alloys.put(GTCEu.id("wizarding_steel"), Optional.empty());
        alloys.put(GTCEu.id("axiom-re"), Optional.empty());
        alloys.put(GTCEu.id("astazine-e"), Optional.empty());
        alloys.put(GTCEu.id("echoing_fluxum_steel"), Optional.empty());
        alloys.put(GTCEu.id("hssd"), Optional.empty());
        alloys.put(GTCEu.id("pentarch-v"), Optional.empty());
        alloys.put(GTCEu.id("energite"), Optional.empty());
        alloys.put(GTCEu.id("auralloy-omega"), Optional.empty());
        alloys.put(GTCEu.id("permendur"), Optional.empty());
        alloys.put(GTCEu.id("tainted_titanium"), Optional.empty());
        alloys.put(GTCEu.id("purified_netherite"), Optional.empty());
        alloys.put(GTCEu.id("desnium"), Optional.empty());
        alloys.put(GTCEu.id("source_attuned_copper"), Optional.empty());
        alloys.put(GTCEu.id("nitinol"), Optional.empty());
        alloys.put(GTCEu.id("osmium_steel"), Optional.empty());
        alloys.put(GTCEu.id("vintanium"), Optional.empty());
        alloys.put(GTCEu.id("berzelianite"), Optional.empty());
        alloys.put(GTCEu.id("tainted_zircalloy"), Optional.empty());
        alloys.put(GTCEu.id("rhodipalladic-desnite"), Optional.empty());
        alloys.put(GTCEu.id("andesite_alloy"), Optional.empty());
        alloys.put(GTCEu.id("hessite"), Optional.empty());
        alloys.put(GTCEu.id("nexus_steel"), Optional.empty());
        alloys.put(GTCEu.id("flesh_alloy"), Optional.empty());
        alloys.put(GTCEu.id("clausthalite"), Optional.empty());
        alloys.put(GTCEu.id("tiemannite"), Optional.empty());
        alloys.put(GTCEu.id("transuranic_naquadrium"), Optional.empty());
        alloys.put(GTCEu.id("fluix"), Optional.empty());
        alloys.put(GTCEu.id("magically_manifested_mechanical"), Optional.empty());
        alloys.put(GTCEu.id("calaverite"), Optional.empty());
        alloys.put(GTCEu.id("igneous_bronze"), Optional.empty());
        alloys.put(GTCEu.id("altaite"), Optional.empty());
        alloys.put(GTCEu.id("tri-osmic_matrix"), Optional.empty());
        alloys.put(GTCEu.id("transplatine"), Optional.empty());
        alloys.put(GTCEu.id("transuranic_naquadrium_alloy"), Optional.empty());
        alloys.put(GTCEu.id("mechanical_stainless"), Optional.empty());
