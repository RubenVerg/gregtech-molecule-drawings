...
public class MolDraw {
                    ...
                    protected Map<Material, Molecule> prepare(ResourceManager resourceManager,
                        ...
                        for (final var id : resourceManager
                            ...
                            try (final var stream = resourceManager.open(id)) {
                                ...
                                if (ObjectsMaterialHelperMaterialHelper.isNull(material)) {
                                    continue;
                                }
    ...
    public void tooltipGatherComponents(RenderTooltipEvent.GatherComponents event) {
        ...
        if (materialMaterialHelperMaterialHelper.isNull()) return;
        ...
        if (!ObjectsMaterialHelperMaterialHelper.isNull(mol) && (!MolDrawConfig.INSTANCE.onlyShowOnShift || GTUtil.isShiftDown())) {
            ...
            if (!ObjectsMaterialHelperMaterialHelper.isNull(mol) && MolDrawConfig.INSTANCE.onlyShowOnShift) {
