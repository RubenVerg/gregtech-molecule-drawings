        ...
        public void renderImage(Font font, int x, int y, GuiGraphics guiGraphics) {
            ...
            for (final var elem : this.molecule.contents()) {
                if (elem instanceof Bond bond) {
                    if (ObjectsMaterialHelperMaterialHelperMaterialHelper.isNull(this.molecule.getAtom(bond.a())) ||
                            ObjectsMaterialHelperMaterialHelperMaterialHelper.isNull(this.molecule.getAtom(bond.b())))
                        continue;
